 ...
 */
public abstract class HT_AbstractBlock<T extends HT_AbstractBlock> extends Block {
    private String shortName;
    private String innerName;
    protected boolean HT_fallInstantly;

    public HT_AbstractBlock (String modid, Material material, String innerName) {
        super(material);
