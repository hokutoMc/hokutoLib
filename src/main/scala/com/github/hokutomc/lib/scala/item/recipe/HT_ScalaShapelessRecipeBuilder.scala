...
class HT_ScalaShapelessRecipeBuilder extends HT_ShapelessRecipeBuilder with HT_T_ScalaRecipeBuilder[HT_ScalaShapelessRecipeBuilder]{
  ...
  def from (item: Item) (function: ISB4RS => AnyISB4R): SELF = {
    function(from(item)).endItem()
    this
  }

  def and (item: Item) (function: ISB4RS => AnyISB4R): SELF = {
    function(and(item)).endItem()
    this
  }

  def to (item: Item) (function: ISB4RS => AnyISB4R): SELF = {
    function(to(item)).endItem()
    this
  }

  def from (item: Block) (function: ISB4RS => AnyISB4R): SELF = {
    function(from(item)).endItem()
    this
  }

  def and (item: Block) (function: ISB4RS => AnyISB4R): SELF = {
    function(and(item)).endItem()
    this
  }

  def to (item: Block) (function: ISB4RS => AnyISB4R): SELF = {
    function(to(item)).endItem()
    this
  }
